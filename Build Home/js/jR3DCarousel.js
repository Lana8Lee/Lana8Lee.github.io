    ...
    $.fn.jR3DCarousel = function(options){
        ...
        (function setup(){
            ...
            function _createNavigation(){
                ...
                var _navigation = $('<div class=navigation />').css({ position: 'absolute', bottom: 0, right: 532});
                ...
                _navigation.find('.nav').css({ display: 'inline-block', margin: '8px', cursor: 'pointer', backgroundColor: 'rgba(255, 255, 255, 0.77)', width: '10px', height: '10px', border: '3px solid #E3F3FB', transition: 'all '+_settings.animationDuration+'ms ease' })
                ...
                /* event handler BUILD YOUR BUSINESS */
                _container.on('click', '.nav-slider__item', function(e){
                    _targetSlideIndex =  $(this).index();
                    _animations.run(_settings.animation, _targetSlideIndex);
                    e.preventDefault();
                });
