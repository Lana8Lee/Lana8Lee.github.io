...
console.log('Начальные значения JSON: ', arrayBD);

var arrSkills = _.map(arrayBD, 'skills');

console.log('Массивы скилов из каждого объекта: ', arrSkills);


var fullListSkills=[];


_.forEach(arrSkills, function(key,value){ fullListSkills=_.concat(fullListSkills, arrSkills[value]);});

console.log('Полный перечень всех скиллов:', fullListSkills);



 var uniqueSkills=[];

 uniqueSkills = _.uniq(fullListSkills);

 console.log('Уникальные скилы перечень:', uniqueSkills);
 
    


var sortedSkills = _.sortBy(uniqueSkills, function (value) { return _.toLower(value); });


console.log('Сортировка по алфавиту: ', sortedSkills);
...
var arrNames = _.map(arrayBD, 'name');

console.log('Массив ИмЁн из JSON объекта До сортировки по кол-ву Друзей: ', arrNames);




var sortedByFriends = _.sortBy(arrayBD, ['friends' , 'name']);


console.log('Сортировка по Количеству друзЭй: ', sortedByFriends);

var arrNamesSorted = _.map(sortedByFriends, 'name');

console.log('Массив ИмЁн из JSON объекта ПОСЛЕ сортировки по кол-ву Друзей: ', arrNamesSorted);
...
var arrFriends = _.map(arrayBD, 'friends');

console.log('Массивы Друзей из каждого объекта: ', arrFriends);


var fullObjectFriends=[];


_.forEach(arrFriends, function(key,value){ fullObjectFriends=_.concat(fullObjectFriends, arrFriends[value]);});




console.log('Полный перечень всех Друзей у Всех с повторениями как Объекты:', fullObjectFriends);


var fullNamesAllFriends = _.map(fullObjectFriends, 'name');


console.log('Полный перечень всех Имён Друзей с повторениями :', fullNamesAllFriends);



 var uniqueFriends=[];

 uniqueFriends = _.uniq(fullNamesAllFriends);

 console.log('Друзья без повторений перечень:', uniqueFriends);
